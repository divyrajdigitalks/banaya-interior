...
const sidebarLinks = [
  ...
  { type: "label", name: "Calculator Flow" },
  { name: "Calculator Services", icon: Calculator, href: "/admin/interiors/services" },
  { name: "Calculator Items", icon: Layers, href: "/admin/calculators" },
