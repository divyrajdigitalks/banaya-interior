        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-2 border-b border-primary/5 pb-8">
                <h1 className="font-serif text-4xl md:text-5xl text-primary font-medium tracking-tight">
                  Shopping <span className="italic font-light text-gold">Cart</span>
                </h1>
